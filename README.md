...
```toml
[dependencies]
noir_rs = { git = "https://github.com/rarimo/noir_rs.git", branch = "v1.0.0-beta.1" }
```
...
```toml
[dependencies]
noir_rs = { git = "https://github.com/rarimo/noir_rs.git", branch = "v1.0.0-beta.1", features = ["barretenberg"] }
```
